...
#                 # 1. One-hot encoding of atomic number
#                 one_hot = self.encode_num(atom.atomicnum)
#                 print(f"One-hot encoding dimension: {len(one_hot)}")

#                 # 2. Named properties
#                 named_props = [atom.__getattribute__(prop) for prop in self.NAMED_PROPS]
#                 print(f"Named properties dimension: {len(named_props)}")

#                 # 3. Callable functions
#                 callables = [func(atom) for func in self.CALLABLES]
#                 print(f"Callable functions dimension: {len(callables)}")
